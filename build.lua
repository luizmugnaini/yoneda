...
local compilers = {
	clang = {
		...
		opt_out_obj = "-o",
		opt_out_exe = "-o",
		flags_common = "-pedantic -Wall -Wextra -Wpedantic -Wuninitialized -Wcast-align -Wconversion -Wnull-pointer-arithmetic -Wnull-dereference -Wformat=2 -Wno-unused-variable -Wno-switch-enum -Wno-unsafe-buffer-usage -Wno-declaration-after-statement",
	...
	gcc = {
		...
		opt_out_obj = "-o",
		opt_out_exe = "-o",
		flags_common = "-pedantic -Wall -Wextra -Wpedantic -Wuninitialized -Wcast-align -Wconversion -Wnull-dereference -Wformat=2 -Wno-unused-variable",
		flags_debug = "-Werror -g -O0 -fsanitize=address -fsanitize=pointer-compare -fsanitize=pointer-subtract -fsanitize=undefined -fstack-protector-strong -fsanitize=leak",
		flags_release = "-O2",
		ar = "ar",
		ar_out = "",
	...
	clang_cl = {
		...
		opt_out_obj = "-o",
		opt_out_exe = "-o",
		flags_common = "/TC -Wall -Wextra -Wconversion -Wuninitialized -Wnull-pointer-arithmetic -Wnull-dereference -Wcast-align -Wformat=2 -Wno-unused-variable -Wno-switch-enum -Wno-unsafe-buffer-usage -Wno-declaration-after-statement",
